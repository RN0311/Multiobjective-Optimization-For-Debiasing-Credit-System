...
def calculate_equalized_odds(xgboost_y_pred, X_test, privileged_group, unprivileged_group):
    ...
    # Calculated True Positive Rate (TPR) and False Positive Rate (FPR) for both groups
...
class CreditRiskProblem(Problem):
    def __init__(self, X_train, y_train, X_test, y_test):
        ...
        # Created the XGBoost classifier
    ...
    def _evaluate(self, X, *args, **kwargs):
        ...
        # Modify the fairness metric to convert it into a minimization problem
...
# Defined the Pareto optimization problem and algorithm
